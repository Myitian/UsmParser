...
A typical CRI USM file is simply an instance of this TLV format, starting with a chunk signature of `CRID`, followed by chunks such as `@SFV`, `@SFA`, `@ALP`, and so on.